...
class InvalidUserName : Exception("\"Invalid username. It must start with a letter and be between 4 and 20 characters long.")
...
class InvalidPassword : Exception("Invalid password. Password must be at least 8 characters long.")
