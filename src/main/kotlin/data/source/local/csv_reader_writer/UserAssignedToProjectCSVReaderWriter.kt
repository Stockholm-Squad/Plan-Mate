...
class UserAssignedToProjectCSVReaderWriter(private val filePath: String) : IReaderWriter<UserAssignedToProjectDto> {
    ...
    override suspend fun overWrite(data: List<UserAssignedToProjectDto>): Boolean {
        data.toDataFrame().writeCSV(resolveFile())
        return true
    }

    override suspend fun append(data: List<UserAssignedToProjectDto>): Boolean {
