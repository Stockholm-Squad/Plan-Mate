...
object UiMessages {
    ...
    const val FAILED_TO_CREATE_TASK = "Failed to create task."
    const val FAILED_TO_ADD_TASK_TO_PROJECT = "Failed to add task to project."
    const val FAILED_TO_EDIT_TASK = "Failed to edit task."
    const val FAILED_TO_DELETE_TASK = "Failed to delete task."
    const val EMPTY_TASK_INPUT = "Inputs are empty"
    const val USER_NAME_PROMPT = "Enter User name"
    const val NO_TASK_FOUND = "No Tasks founded"
